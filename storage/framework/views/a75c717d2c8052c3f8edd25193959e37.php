...
<form method="post" action="<?php echo e(route('pessoas.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="container">
        <div class="row g-3">
...
<?php echo $__env->make('secretaria.layout_secretaria.pagina_inicialSecretaria', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sistemaagendamento\resources\views/secretaria/sistema/Pessoa/create.blade.php ENDPATH**/ ?>