...
<body>
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <?php if(session()->has('sucesso-agendamentos')): ?>
                <div class="alert alert-success alert-dismissible fade show col-12" role="alert">
                    <?php echo e(session()->get('sucesso-agendamentos')); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover align-middle">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $agendamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
...
<?php /**PATH C:\xampp\htdocs\sistemaagendamento\resources\views/secretaria/sistema/agendamento/index.blade.php ENDPATH**/ ?>