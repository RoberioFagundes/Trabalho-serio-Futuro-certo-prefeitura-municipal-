<?php echo $__env->yieldContent('menu_gestor'); ?>
<ul id="sidebarnav">
     ...
     <li class="sidebar-item">
        <a class="sidebar-link justify-content-between" href="#" aria-expanded="false">
            <div class="d-flex align-items-center gap-3">
                ...
                <span class="hide-menu">Atender</span>
            </div>
...
<?php /**PATH C:\xampp\htdocs\sistemaagendamento\resources\views/prefeito/layout/menu.blade.php ENDPATH**/ ?>